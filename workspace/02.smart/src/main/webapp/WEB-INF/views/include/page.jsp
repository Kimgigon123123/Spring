...
<li class="page-item"><!--처음으로  --><a class="page-link" onclick="page(1)"><i class="fa-solid fa-angles-left"></i></a></li>
<%-- <li class="page-item"><!--이전으로  --><a class="page-link" onclick="page(${page.beginPage-1})"><i class="fa-solid fa-angle-left"></i></a></li> --%>
<li class="page-item"><!--이전으로  --><a class="page-link" onclick="page(${page.beginPage-page.blockPage})"><i class="fa-solid fa-angle-left"></i></a></li>
</c:if>
