			...
			<div class="col-xl-3-20 col-md-6 mb-4">
		        <div class="card">
		            <div class="card-body">
		            	...
		            	<a class="text-link" href="javascript:info(${vo.id })">${vo.title }${vo.title }</a>
		            	</div>
		            </div>
...
<!-- 
table 태그의 td의 내용이 길어질때 ... 처리하려면
table 태그의 css에서 table-layout: fiexd 로 지정, td에 text-truncate 클래스 지정 -->
